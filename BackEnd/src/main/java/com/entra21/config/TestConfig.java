...
//		paymentRepository.saveAll(Arrays.asList(pay1,pay2,pay3));
		...
		Booking bk2 = new Booking(null, c2, LocalDate.parse("2005-10-20"), LocalDate.parse("2005-10-30"),
				cat1.getDayPrice(), cat1.getWeekPrice(), 1000.00, cat1, BookingStatus.ACTIVE, null);
