...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Address ad2 = new Address(null, "88095000", "Av Marinheiro Max Schramm", "Estreito", "2428", "Bloco 4 Apto 301", c2);

		addressRepository.save(ad2);
		
		Booking bk2 = new Booking(null, c2, Instant.parse("2005-10-20T00:00:00Z"), Instant.parse("2005-10-30T00:00:00Z"),
						cat1.getDayPrice(), cat1.getWeekPrice(), cat1, BookingStatus.ACTIVE, null);
