...
import com.entra21.services.ReceiptService;
...
public class ReceiptController {
	...
	public ResponseEntity<Receipt> findById(@PathVariable Long id){
		Receipt obj = service.findById(id);
		return ResponseEntity.ok().body(obj);
	}
	
	@PostMapping
	public ResponseEntity<Receipt> insert(@RequestBody Receipt obj){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Receipt> update(@PathVariable Long id, @RequestBody Receipt obj) {
